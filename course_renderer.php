 ...
 */
class format_edtech_course_renderer extends plugin_renderer_base {
    ...
    public function course_info_box(stdClass $course) {
        ...
        $chelper = new edtech_coursecat_helper();
    ...
    function course_section_add_cm_control($course, $section, $sectionreturn = null, $displayoptions = array()) {
        ...
        if (course_ajax_enabled($course) && $course->id == $this->page->course->id) {
            ...
            $modchooser .= html_writer::tag('span', $icon, array('class' => 'section-modchooser-link'));
    ...
    public function courses_list($courses, $showcategoryname = false, $additionalclasses = null, $paginationurl = null, $totalcount = null, $page = 0, $perpage = null) {
        global $CFG;
        // create instance of edtech_coursecat_helper to pass display options to function rendering courses list
        $chelper = new edtech_coursecat_helper();
        if ($showcategoryname) {
     ...
     *
     * @param edtech_coursecat_helper $chelper various display options
     * @param course_in_list|stdClass $course
     * @param string $additionalclasses additional classes to add to the main <div> tag (usually
     *    depend on the course position in list - first/last/even/odd)
     * @return string
     */
    protected function coursecat_coursebox(edtech_coursecat_helper $chelper, $course, $additionalclasses = '') {
        global $CFG;
     ...
     * @return string
     */
    protected function coursecat_coursebox_content(edtech_coursecat_helper $chelper, $course) {
        global $CFG;
        if ($chelper->get_show_courses() < self::COURSECAT_SHOW_COURSES_EXPANDED) {
            return '';
        }
     ...
     * @return string
     */
    protected function coursecat_courses(edtech_coursecat_helper $chelper, $courses, $totalcount = null) {
        global $CFG;
        if ($totalcount === null) {
     ...
     * @return string
     */
    protected function coursecat_subcategories(edtech_coursecat_helper $chelper, $coursecat, $depth) {
        global $CFG;
        $subcategories = array();
     ...
     * @return string
     */
    protected function coursecat_category_content(edtech_coursecat_helper $chelper, $coursecat, $depth) {
        $content = '';
        // Subcategories
     ...
     * @return string
     */
    protected function coursecat_category(edtech_coursecat_helper $chelper, $coursecat, $depth) {
        // open category tag
     ...
     * @return string
     */
    protected function coursecat_tree(edtech_coursecat_helper $chelper, $coursecat) {
...
class edtech_coursecat_helper {
     ...
     * @return edtech_coursecat_helper
     */
     ...
     *
     * @see edtech_coursecat_helper::set_courses_display_options()
     *
     * @param string $key
     * @param mixed $value
     * @return edtech_coursecat_helper
