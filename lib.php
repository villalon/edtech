...
/**
 * Main class for the edTech course format
 *
 * @package    format_edtech
 * @copyright  2015 Jorge Villalon
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_edtech extends format_base {
    ...
    public function get_section_name($section) {
        ...
        if ((string)$section->name !== '') {
            ...
            return get_string('section0name', 'format_edtech');
        } else {
     ...
     *
     * Edtech format uses the following options:
     * - coursedisplay
     * - numsections
     * - hiddensections
     *
     ...
     *
     * In case if course format was changed to 'edtech', we try to copy options
